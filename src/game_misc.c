...

{
  ...
  if (((unsigned short)((param_1) >> 16)) != 0) {
    loc_4 = FUN_004608a0(this,(byte)param_1);
    c1 = FUN_00460730(param_1,(int)loc_4,param_2,param_3);
    FUN_004609a0(&loc_4);
    return c1;
  }
...

{
  ...
  FUN_00460670(this,param_1,&loc_8,&loc_4);
  pu1 = FUN_004600c0(this,loc_8,0);
  if (pu1 != (ushort *)0x0) {
...

{
  ...
  FUN_00461130(this,param_1,&loc_8,&loc_4,param_3);
  if (loc_8 < 0x1e8481) {
    if (loc_4 != 0) {
      if (param_2 == (ushort *)0x0) {
        if (loc_8 != 0) {
          param_2 = FUN_004600c0(this,loc_8,0);
        }
        if (param_2 == (ushort *)0x0) {
          return (ushort *)0x0;
        }
      ...
      if (loc_8 != 0) {
        ...
        loc_4 = loc_4 + param_4;
        loc_8 = loc_8 - param_4;
        FUN_004178e0(pv1,loc_4);
        FUN_004179a0(pv1,loc_8,param_2);
        return param_2;
      }
    }
    return (ushort *)0x0;
...

{
  ...
  if (*(short *)(*(int *)((intptr_t)this + 0xc) + 0xc) != 0) {
    do {
      loc_4 = FUN_004608a0(this,b1);
      if ((*(int *)(loc_4 + 9) == param_1) && (*(int *)(loc_4 + 0xb) == param_2)) {
        FUN_004609a0(&loc_4);
        return b1;
      }
      b1 = b1 + 1;
...

{
  ...
  FUN_00401060(&DAT_00489b18,u1,__param_fffffff4);
  return;
}
...

{
  ...
  loc_4 = FUN_004608a0(this,param_1);
  u1 = loc_4[7];
  u2 = loc_4[6];
  FUN_004609a0(&loc_4);
  return u1 - u2;
...

{
  ...
  FUN_00460670(this,param_1,&loc_4,&loc_8);
  pv1 = (HANDLE)FUN_00462160(this,param_1);
  u2 = FUN_00461270(param_2,loc_4,loc_8,pv1);
...

{
  ...
  u4 = 0;
  loc_c = FUN_004608a0(this,(byte)param_1);
  if (loc_c == (ushort *)0x0) {
    return 0;
  }
  if (loc_c[8] == 8) {
    c2 = FUN_00460730(param_1,(int)loc_c,&loc_4,&loc_8);
    if (c2 != '\0') {
      FUN_004178e0(*(HANDLE *)((intptr_t)this + 8),loc_8);
...

{
  ...
  if (((unsigned short)((param_1) >> 16)) != 0) {
    ...
    loc_4 = FUN_004608a0(this,(byte)param_1);
    if (loc_4 != (ushort *)0x0) {
      if (((unsigned short)((param_1) >> 16)) <= loc_4[7]) {
        u1 = (uint)((unsigned short)((param_1) >> 16));
        if ((*(int *)(loc_4 + u1 * 7 + 9) != 0) && (loc_4[u1 * 7 + 6] != 0)) {
          loc_4[u1 * 7 + 6] = loc_4[u1 * 7 + 6] + 1;
          pu2 = *(ushort **)(loc_4 + u1 * 7 + 0xb);
        }
      }
      FUN_004609a0(&loc_4);
    }
    ...
    if ((byte)param_1 != 0) {
      ...
      if (loc_4 != (ushort *)0x0) {
        ...
        if (u2 != 0) {
          loc_4[u3 * 7 + 6] = u2 - 1;
          if (loc_4[u3 * 7 + 6] == 0) {
            if (*(uint *)(loc_4 + u3 * 7 + 0xb) != 0) {
              FUN_0046f5f0(*(uint *)(loc_4 + u3 * 7 + 0xb));
            }
            (loc_4 + u3 * 7 + 0xb)[0] = 0;
            (loc_4 + u3 * 7 + 0xb)[1] = 0;
  ...
  if ((param_2 != 0) && (((unsigned short)((param_1) >> 16)) != 0)) {
    if ((byte)param_1 != 0) {
      ...
      if (loc_4 != (ushort *)0x0) {
        ...
        if ((loc_4[u2 * 7 + 6] == 0) && (*(int *)(loc_4 + u2 * 7 + 0xb) == 0)) {
          loc_4[u2 * 7 + 6] = 1;
          *(int *)(loc_4 + u2 * 7 + 0xb) = param_2;
          ps1 = (short *)(*(int *)((intptr_t)this + 0xc) + 0xc + (param_1 & 0xff) * 0xe);
          *ps1 = *ps1 + 1;
        }
        FUN_004609a0(&loc_4);
...

{
  ...
  if ((u1 & 0x80000000) == 0) {
    ...
    u6 = *(uint *)(pu4 + u3 * 7 + 7) & 0x7fffffff;
    if ((this->pos_w < u6 + u2) ||
       (pu5 = FUN_004600c0(this,u6,0), pu5 == (ushort *)0x0)) goto __label_00461a2c;
    FUN_004178e0(*(HANDLE *)((intptr_t)this + 8),u1 & 0x3fffffff);
    FUN_004179a0(*(HANDLE *)((intptr_t)this + 8),u6,pu5);
    FUN_004178e0(this->pos_x,u2);
    FUN_00452970(this->pos_x,u6,pu5);
...

{
  ...
  if (*(int *)((int)param_1 + 0x26) != 0) { /* TODO: resource manager field 0x26 */
    ...
    if (*(short *)(*(int *)((int)param_1 + 0xc) + 0xc) != 0) { /* TODO: resource manager->0x0c->0x0c */
      do {
        pu3 = (ushort *)0x0;
        n2 = *(int *)(*(int *)((int)param_1 + 0xc) + 0x16 + (uint)loc_b * 0xe); /* TODO: resource manager->0x0c->0x16 + stride 0x0e */
        if (n2 != 0) {
          loc_a = 1;
          if (*(short *)(n2 + 0xe) != 0) {
            do {
              n1 = n2 + 0xc + (uint)loc_a * 0xe;
              if ((*(byte *)(n1 + 9) & 0x40) != 0) {
                if (pu3 == (ushort *)0x0) {
                  loc_4 = (uint)loc_b;
                  pu3 = FUN_00460780(param_1,loc_4);
                  FUN_0045feb0((int)pu3,'\0');
                }
                *(uint *)(n1 + 6) = *(uint *)(pu3 + (uint)loc_a * 7 + 9) & 0x3fffffff;
              }
              loc_a = loc_a + 1;
            } while (loc_a <= *(ushort *)(n2 + 0xe));
          }
          if (pu3 != (ushort *)0x0) {
        ...
        loc_b = loc_b + 1;
      } while ((ushort)loc_b <= *(ushort *)(*(int *)((int)param_1 + 0xc) + 0xc)); /* TODO: resource manager->0x0c->0x0c */
    }
...

{
  ...
  if (*(short *)(*(int *)(*(int *)((int)param_1 + 0x20) + 0xc) + 0xe) != 0) { /* TODO: resource manager->0x20->0x0c->0x0e */
    do {
      pu2 = FUN_004608a0(*(void **)((int)param_1 + 0x20),loc_11); /* TODO: resource manager field 0x20 */
      if (pu2 != (ushort *)0x0) {
        if (*(ushort *)(*(int *)((int)param_1 + 0xc) + 0xc) < (ushort)loc_11) { /* TODO: resource manager->0x0c->0x0c */
          FUN_00460510(param_1,pu2[7],pu2[8],*(int *)(pu2 + 9),
                       *(int *)(pu2 + 0xb));
        }
        pu3 = FUN_004608a0(param_1,loc_11);
        if (pu3 != (ushort *)0x0) {
          if (pu3[7] < pu2[7]) {
            FUN_004623a0(param_1,loc_11,pu2[7]);
          }
          u7 = 1;
          if (pu2[7] != 0) {
            do {
              ...
              if ((*(int *)(pu2 + n4 * 7 + 9) != 0) && (*(int *)(pu2 + n4 * 7 + 7) != 0)
                ...
                loc_8 = (uint)u7 << 0x10;
                loc_8 = CONCAT31((((loc_8) >> 8) & 0xFFFFFF),loc_11);
                FUN_00461130(*(void **)((int)param_1 + 0x20),loc_8,&loc_4,(uint *)&loc_c, /* TODO: resource manager field 0x20 */
                             pu2);
                if (*(int *)(pu3 + n4 * 7 + 9) == 0) {
                  if (loc_4 != 0) {
                    pu3[6] = pu3[6] + 1;
__label_00461f1a:
                  ...
                  if (loc_4 != 0) goto __label_00461f1a;
                  (pu3 + n4 * 7 + 9)[0] = 0;
                  (pu3 + n4 * 7 + 9)[1] = 0;
                  (pu3 + n4 * 7 + 7)[0] = 0;
                  (pu3 + n4 * 7 + 7)[1] = 0;
      ...
      loc_11 = loc_11 + 1;
      pv5 = (void *)CONCAT22((short)((uint)param_1 >> 0x10),(ushort)loc_11);
    } while ((ushort)loc_11 <= *(ushort *)(*(int *)(*(int *)((int)param_1 + 0x20) + 0xc) + 0xe)); /* TODO: resource manager->0x20->0x0c->0x0e */
  }
...

{
  ...
  FUN_00401050(&__stk_44,0);
  FUN_00401050(&__stk_43,0);
  FUN_00401060(&DAT_00489b28,u1,__param_fffffff4);
  return;
}
...

{
  ...
  FUN_00401050(&__stk_44,0);
  FUN_00401050(&__stk_43,0);
  FUN_00401060(&DAT_00489b38,u1,__param_fffffff4);
  return;
}
...

{
  ...
  FUN_00401050(&__stk_44,0);
  FUN_00401050(&__stk_43,0);
  FUN_00401060(&DAT_00489b70,u1,__param_fffffff4);
  return;
}
...

{
  ...
  for (pu1 = DAT_00489b50; pu1 != (int *)0x0; pu1 = (int *)pu1[1]) {
...

{
  ...
  for (pu2 = DAT_00489b50; pu2 != (int *)0x0; pu2 = (int *)pu2[1]) {
    u3 = 1;
    u4 = 0;
    do {
      n1 = (short)u4 * 6;
...

{
  ...
  FUN_00401050(&__stk_44,0);
  FUN_00401050(&__stk_43,0);
  FUN_00401060(&DAT_00489ba0,u1,__param_fffffff4);
  return;
}
...

{
  ...
  if (param_1 == '\0') {
    *(ushort *)this = CONCAT11((char)*(short *)this,(char)((ushort)*(short *)this >> 8));
    loc_8 = (short *)&this->font_size;
    *loc_8 = CONCAT11((char)*loc_8,(char)((ushort)*loc_8 >> 8));
    u2 = this->font_id;
    loc_c = loc_2c;
    ...
    loc_2c[0] = CONCAT22(CONCAT11((char)u3,(char)((uint)u3 >> 8)),
                           CONCAT11((char)((uint)u3 >> 0x10),(char)((uint)u3 >> 0x18)));
    s6 = 0;
    *(int *)((intptr_t)this + 2) = loc_2c[0] + (intptr_t)this;
    loc_4 = this;
    if (0 < *(short *)this) {
      do {
        ...
        n5 = *pn4;
        loc_14 = loc_2c;
        loc_2c[0] = CONCAT22(CONCAT11((char)n5,(char)((uint)n5 >> 8)),
                               CONCAT11((char)((uint)n5 >> 0x10),(char)((uint)n5 >> 0x18)));
        s6 = s6 + 1;
        *pn4 = loc_2c[0] + (intptr_t)this;
      } while (s6 < *(short *)this);
    }
  }
  s6 = 0;
...

{
  ...
  FUN_00401050(&__stk_44,0);
  FUN_00401050(&__stk_43,0);
  FUN_00401060(&DAT_00489bb0,u1,__param_fffffff4);
  return;
}
...

{
  ...
  if (n2 != 0) {
    ...
    __reg_eax = CONCAT22((short)(__reg_eax >> 0x10),s1);
    if (s1 != 0) {
...

{
  ...
  if ((ps4 != (short *)0x0) && (c1 = (char)ps4[3], c1 != '\0')) {
    if (this->field_10 == (ushort *)0x0) {
      if ((ps4 == (short *)0x0) || (c1 == '\0')) {
        pu2 = (int *)0x0;
      }
      else {
        pu2 = (int *)((uint)(ushort)ps4[4] + *ps4 * 2 + 0xe + (int)ps4);
      }
      pu3 = FUN_0045c1c0(pu2,-1,-1,(ushort *)0x0);
...

{
  ...
  FUN_00401050(&__stk_44,0);
  FUN_00401050(&__stk_43,0);
  FUN_00401060(&DAT_00489bc0,u1,__param_fffffff4);
  return;
}
  ...
  if ((n1 != 0) &&
    ...
    if (0 < *(short *)(param_3 + 2)) {
      do {
        ...
        if (pb3 != (byte *)0x0) {
          FUN_0046a8b0(pb3,CONCAT31((unsigned int)((uint)__saved_ebx >> 8),param_1),param_2,
                       this->field_14);
        }
        s4 = s4 + 1;
      } while (s4 < *(short *)(param_3 + 2));
...

{
  ...
  if ((char)u1 != '\0') {
    ...
    if ((char)u1 != '\0') {
      pu2 = FUN_004607d0(param_1,param_2,(ushort *)0x0,(ushort *)0x0,0);
      if (pu2 != (ushort *)0x0) {
    ...
    if (0 < *(short *)(param_1 + 1)) {
      do {
        ...
        *pn1 = CONCAT22(CONCAT11((char)(short)*pn1,(char)((ushort)(short)*pn1 >> 8)),
        ...
        if (0 < s4) {
          do {
            if (param_1[s3 + 2] == *pn1) goto __label_0046b85a;
            s3 = s3 + 1;
          } while (s3 < s4);
        }
        if (param_2 != '\0') {
...

{
  ...
  FUN_00401050(&__stk_44,0);
  FUN_00401050(&__stk_43,0);
  FUN_00401060(&DAT_00489bd0,u1,__param_fffffff4);
  return;
}
...

{
  ...
  FUN_00401050(&__stk_44,0);
  FUN_00401050(&__stk_43,0);
  FUN_00401060(&DAT_00489be0,u1,__param_fffffff4);
  return;
}
...

{
  ...
  FUN_00401050(&__stk_44,0);
  FUN_00401050(&__stk_43,0);
  FUN_00401060(&DAT_00489bf0,u1,__param_fffffff4);
  return;
}
...

{
  ...
  if (param_2 == 0) {
    ...
    if ((short)u3 != 0) goto __label_0046c5b7;
    u3 = 0x1000;
  }
  else {
__label_0046c5b7:
 ...
 * Offsets 0x0e, 0x15 are page descriptor fields; loc_4 is a pool descriptor
...
__label_0046d53f:
  ...
  if ((*(byte *)(loc_4 + 0x22) & 2) != 0) {
    EnterCriticalSection((LPCRITICAL_SECTION)(loc_4 + 0x48));
    *(int *)(loc_4 + 0x60) = *(int *)(loc_4 + 0x60) + 1;
  }
  ...
  u5 = 0;
  FUN_0046fd70(loc_4,6);
__label_0046d5f9:
  if ((*(byte *)(loc_4 + 0x22) & 2) != 0) {
    *(int *)(loc_4 + 0x60) = *(int *)(loc_4 + 0x60) + -1;
    LeaveCriticalSection((LPCRITICAL_SECTION)(loc_4 + 0x48));
  }
  return u5;
}
...

{
  ...
  pn1 = (int *)((int)param_1 + (uint)loc_6 * 4);
  n2 = *pn1;
  if (param_2 != 0) {
    do {
      pn3 = FUN_0046e980(param_1,loc_6,(uint)*(ushort *)((int)param_1 + 0x28),0); /* TODO: SmartHeap pool min_block at 0x28 */
      if (pn3 == (int *)0x0) break;
  ...
  if (*(int *)((int)param_1 + 0x16c) == 0) { /* TODO: SmartHeap pool field at 0x16c */
    ...
    *(int *)((int)param_1 + 0x2c) = *(int *)((int)param_1 + 0x2c) + -0x1000; /* TODO: SmartHeap pool current_size at 0x2c */
    ...
    if (loc_8 < 0xffff) {
      ...
      if (n3 != 0) {
        pu5 = (int *)((loc_8 - 0x178 & 0xfffffff0) + 0x178 + (int)param_1);
        *(int *)((int)param_1 + 0x2c) = *(int *)((int)param_1 + 0x2c) - loc_8; /* TODO: SmartHeap pool current_size at 0x2c */
      }
    }
    else {
      u2 = 0;
  ...
  if (pu5 == (int *)0x0) {
    ...
    if (pu4 != (int *)0x0) {
      ...
      if (loc_8 < 0xffff) {
        ...
        if (n3 != 0) {
          pu5 = (int *)((loc_8 - 0x14 & 0xfffffff0) + 0x14 + (int)pu4);
    ...
    *(int **)((int)param_1 + 0x164) = pu4; /* TODO: SmartHeap pool overflow_chain at 0x164 */
    ...
    loc_4 = (int *)((u2 - 0x18) + (int)param_1);
  }
__label_0046e844:
  if (loc_4 == (int *)0x0) {
    u2 = u2 + 0xfff & 0xfffff000;
    *(int *)((int)param_1 + 0x2c) = *(int *)((int)param_1 + 0x2c) - loc_8; /* TODO: SmartHeap pool current_size at 0x2c */
    loc_4 = (int *)((u2 - 0x1c) + (int)pu4);
  }
...

{
  ...
  {
    FUN_0046e920(n2,n3,CONCAT22((short)((uint)__saved_esi >> 0x10),u1) & 0xffff0007);
    b4 = true;
...

{
  ...
  if (param_2 == (int *)0x0) {
    ...
    n5 = param_1[1];
    while (pn3 = FUN_00471280(param_1,param_3 + 0x1cU,u6 | 0x2000), pn3 == (int *)0x0) {
...

{
  ...
  *(int **)(param_1 + 0x10) = pu2;
  ...
  pu4 = (int *)CONCAT22((short)((uint)__reg_eax >> 0x10),u3 / param_2);
...

{
     ...
     (ushort)((short)*(int *)(u9 + 0x14) - (short)*(int *)(u9 + 0x10)) < u4))
  {
    ...
    if (((param_2 & 0x10) != 0) ||
       (pn6 = FUN_0046e980(param_1,4,0x10000,0), pn6 == (int *)0x0)) {
...

{
  ...
  case 1:
    ...
    break;
  case 3:
    if ((param_1 != (int *)0x0) && (param_3 <= *(ushort *)(*pn6 + 0x2a))) {
    ...
    if ((pu4 == (ushort *)0x0) && (param_1 == (int *)0x0)) {
      return 1;
    }
    break;
  case 4:
    ...
    if (((param_4 & 1) != 0) && (u5 < u9)) {
      ...
      for (u10 = u10 & 3; pu4 = (ushort *)0x0, u10 != 0; u10 = u10 - 1) {
        *(char *)pu11 = 0;
        pu11 = (int *)((int)pu11 + 1);
      }
    }
