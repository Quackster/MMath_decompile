...
char __thiscall FUN_00460670(void *this,uint param_1,uint *param_2,uint *param_3)
{
  ...
  n2 = (param_1 & 0xff) * 0xe + (int)((ResourceManager *)this)->bank_ptr; /* TODO: custom internal struct via offset 0xc */
...
char __thiscall FUN_00461320(void *this,int param_1,LPVOID param_2)
{
  ...
  if (vc[8] == 8) {
    ...
    if (c2 != '\0') {
      ...
      u4 = 1;
      *((char *)param_2 + 0x3f) = 0; /* resource block: ready flag for block A */
      *((char *)param_2 + 0x13f) = 0; /* resource block: ready flag for block B */
    }
  }
  FUN_004609a0(&vc);
  return u4;
          ...
          if (pu2[7] != 0) {
            do {
              ...
              if ((*(int *)(pu2 + n4 * 7 + 9) != 0) && (*(int *)(pu2 + n4 * 7 + 7) != 0)
                ...
                FUN_00461130(((ResourceManager *)param_1)->secondary_mgr,v8,&v4,(uint *)&vc, /* TODO: resource manager field 0x20 */
                             pu2);
                if (*(int *)(pu3 + n4 * 7 + 9) == 0) {
                  if (v4 != 0) {
                    pu3[6] = pu3[6] + 1;
  ...
  for (pu2 = DAT_00489b50; pu2 != NULL; pu2 = (int *)pu2[1]) {
    ...
    do {
      ...
      if ((&DAT_00483a10)[(short)u4 * 3] == *(short *)(pu2 + 2)) {
        ...
        else if ((((LinkedListNode *)pu2)->node_flag == '\0') || (DAT_00489b68 == 1)) {
          s5 = 1;
        }
        else {
          s5 = 2;
...
{
  /* Music/rendering function (~207 lines). Processes note data. */
  return;
}
...
{
  /* Music/rendering function (~355 lines). Processes note data. */
  return;
}
...
{
  /* Music/rendering function (~424 lines). Processes note data. */
  return;
}
...
{
  /* Music/rendering function (~455 lines). Processes note data. */
  return;
}
...
{
  /* Music/rendering function (~203 lines). Processes note data. */
  return;
}
...
{
  /* Music/rendering function (~357 lines). Processes note data. */
  return;
}
...
{
  /* Music/rendering function (~373 lines). Processes note data. */
  return;
}
...
{
  /* Music/rendering function (~456 lines). Processes note data. */
  return;
}
...
bool __fastcall FUN_0046e6b0(LPCVOID param_1)
{
  ...
  if (((SmartHeapPool *)param_1)->pool_field == 0) {
    u2 = 0x1000;
    pu5 = (int *)&((SmartHeapPool *)param_1)->fallback_ptr;
...
uint __fastcall FUN_0046efa0(int *param_1,uint param_2)
{
  ...
  pu1 = &((SmartHeapPool *)param_1)->free_area_start;
  pu4 = (short *)
