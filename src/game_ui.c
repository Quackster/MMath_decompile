        ...
        if (s1 < (short)u2) {
          ...
          if (s4 < s3) {
            if (((unsigned short)((loc_18) >> 16)) < ((unsigned short)((loc_14) >> 16))) {
              if ((short)loc_14 <= (short)loc_18) goto L_00430923;
              ...
              if (s3 <= (short)loc_14) goto L_00430933;
            }
            else {
L_00430923:
...

{
  ...
  _handler = &L_00432b78;
  *_fs = &loc_10;
  FUN_004329d0(loc_3c,(int *)&_tmp_0);
  loc_8 = 0;
  pu2 = loc_38;
  pu3 = (int *)&_tmp_23;
