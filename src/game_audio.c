            ...
            char param_6)
{
  ...
  *_fs = &v10;
  ...
  if (v1c != (ushort *)0x0) {
    ...
    v24 = FUN_0042c5b0((short *)v1c,&v30,(ushort *)0x0);
    if (v24 != (ushort *)0x0) {
      s7 = 0;
      if (0 < (short)*v1c) {
        do {
...
int FUN_0044bf50(int *param_1,char param_2)
{
  ...
  *(int *)(v18 + 0x40) = 0;
  ...
  _seh_state = 1;
  if ((v3c != (int *)0x0) && (pc8 = (char *)*v3c, pc8 != (char *)0x0)) {
    c1 = *pc8;
    while (c1 != '\0') {
      pc8 = pc8 + 1;
      u10 = u10 + 1;
  ...
  if (*(int *)(v18 + 0xc) + -1 < (int)u10) {
    ...
    if (*(uint **)(v18 + 8) == (uint *)0x0) {
      pv4 = *(LPCVOID *)(v18 + 0x10);
      if (*(LPCVOID *)(v18 + 0x10) == (LPCVOID)0x0) {
        pv4 = DAT_00483df4;
      }
